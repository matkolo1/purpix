...
// Kontrola hodnoty ve sloupci purpix_level_XXX
if ($urlNumber > 0) {
	$stmt = $conn->prepare("SELECT purpix_level_$urlNumber FROM users_alba_rosa WHERE idusers = ?");
...
<head>
    ...
    <title>Alba-rosa.cz | Purpix | 4</title>
</head>
